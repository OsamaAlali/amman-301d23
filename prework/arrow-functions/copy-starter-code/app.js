...
// STEP 5
// What if we have multiple parameters? we must put them in parentheses in arrowfunction
...
console.log('new objectList ',newObjectList());
...
Student.prototype.greeting = () => {
  return `Hi, my name is ${this.name}`;
}; /// return nothing becouse this refar to Global
...
// 1. What is "this" when joe.scope() is invoked? nothing because theres no objact declare locally

// 2. What is "this" when joe.scopeArrow() is invoked? return window object (global object)
//
// 3. Explain why "this" is different when an arrow function is used.? becuase its intilize where object callmethod if called in global this will refare to global object
// 
